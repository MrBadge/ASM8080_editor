...
namespace ASMgenerator8080
{
    class BinaryGenerator
    {
        ...
        private const Dictionary<string, char> ops0 = new Dictionary<string, char>()
        { 
            { "nop" , (char)0x00 },
            { "hlt" , (char)0x76 },
            { "ei"  , (char)0xfb },
        ...
        private const Dictionary<string, char> opsIm16 = new Dictionary<string, char> ()
        {
            { "lda" , (char)0x3a },
            { "sta" , (char)0x32 },
            { "lhld", (char)0x2a },
        ...
        private const Dictionary<string, char> opsRpIm16 = new Dictionary<string, char>()
        {
            { "lxi", (char)0x01 }
        };

        private const Dictionary<string, char> opsIm8 = new Dictionary<string, char>()
        {
            { "adi", (char)0xc6 },
            { "aci", (char)0xce },
            { "sui", (char)0xd6 },
        ...
        private const Dictionary<string, char> opsRegIm8 = new Dictionary<string, char>()
        {
            { "mvi", (char)0x06 }
        };

        private const Dictionary<string, char> opsRegReg = new Dictionary<string, char>()
        {
            { "mov", (char)0x40 }
        };

        private const Dictionary<string, char> opsReg = new Dictionary<string, char>()
        {
            { "add", (char)0x80 },
            { "adc", (char)0x88 },
            { "sub", (char)0x90 },
        ...
        private const Dictionary<string, char> opsRp = new Dictionary<string, char>()
        {
            { "ldax", (char)0x0A },
            { "stax", (char)0x02 },
            { "dad" , (char)0x09 },
        ...
        private referencesLabel(identifier, linenumber) {
